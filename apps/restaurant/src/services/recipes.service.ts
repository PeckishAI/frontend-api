...
const getRecipes = async (
  ...
  console.log('recipe service', res.data);
...
type FormRecipe = {
  ...
  ingredients: {
    ...
    type: string;
    conversion_factor: number;
    recipe_unit_name?: string; // Make this optional
    recipe_unit_uuid?: string;
  }[];
};
...
const updateRecipe = (
  ...
  console.log('Updating recipe/preparation:', data);
...
export const recipesService = {
  getRecipes,
  getPreparations, // New function to fetch preparations
  createRecipe,
  updateRecipe,
  deleteRecipe,
};
